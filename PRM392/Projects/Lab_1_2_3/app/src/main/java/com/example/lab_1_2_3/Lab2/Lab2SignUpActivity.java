...
public class Lab2SignUpActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnBackLab2Sign3).setOnClickListener(v -> finish());
