...
public class Lab2SignInActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnBackLab2Sign).setOnClickListener(v -> finish());
    ...
    private void signIn() {
        ...
        // Start MainActivity
        Intent intent = new Intent(this, Lab2SignInSuccessActivity.class);
        startActivity(intent);
        finish(); // close current activity
    }

    private void signUpForm() {
        Intent intent = new Intent(this, Lab2SignUpActivity.class);
        startActivity(intent);
        finish();
    }
